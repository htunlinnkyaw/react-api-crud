...
const LoaderRow = () => {
  return (
    <tr className="bg-white border-b animate-pulse dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
      ...
      >
        <div className="h-2.5 ms-2 bg-gray-300 rounded-full dark:bg-gray-600 w-10" />
      </th>
      ...
      <td className="px-6 py-4 cell-editable row-short" cell-col="short_name">
        <div className="h-2.5 ms-2 bg-gray-300 rounded-full dark:bg-gray-600 w-20" />
      </td>
      <td className="px-6 py-4 cell-editable row-fee" cell-col="fee">
        <div className="h-2.5 ms-2 bg-gray-300 rounded-full dark:bg-gray-600 w-42" />
      </td>
      <td className="px-6 py-4 text-right flex gap-2">
        <div className="h-10 w-10 ms-2 bg-gray-300 rounded-full dark:bg-gray-300" />
        <div className="h-10 w-10 ms-2 bg-gray-300 rounded-full dark:bg-gray-600" />
      </td>
    </tr>
  );
};
